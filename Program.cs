...
namespace BaltaDataAccess
{
    class Program
    {
        const string connectionString = "Server=DESKTOP-BKLEGIN\\SQLEXPRESS2019;Database=balta;User ID=sa;Password=sa123";
        ...
        {
            var categories = connection.Query<Category>("SELECT [Id], [Title], [Order] FROM [Category] order by [Order]");
        ...
        {
            var query = @"select * from Career where [Id] IN @Ids";
